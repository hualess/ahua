<template>
  <div class="about">
    ...
    <img class="avatar" src="../../assets/img/img-4.jpg" alt="">
    <p class="name">ahua</p>
    <p class="desc">分享技术 品味人生</p>
    <p class="desc">Write the code, Change the World</p>
    <ul class="social" style="margin-left: 50px">
      <li style="float:left"><a href="https://gitee.com/liubaohua666" target="_blank"><img src="../../assets/icon/WeiBo.png" alt=""></a></li>
      <li style="float:left"><a href="https://gitee.com/liubaohua666" target="_blank"><img src="../../assets/icon/GitHub.png" alt=""></a></li>
      <li style="float:left"><a href="https://gitee.com/liubaohua666" target="_blank"><img src="../../assets/icon/qq.png" alt=""></a></li>
    </ul>
